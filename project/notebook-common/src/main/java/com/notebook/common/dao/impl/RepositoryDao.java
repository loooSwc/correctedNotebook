package com.notebook.common.dao.impl;
...
import com.notebook.common.dao.QueryMap;
import com.notebook.common.dao.support.Page;
...
public class RepositoryDao<T, ID extends Serializable> extends
	...
	public Page pagedQuery(final String ql, final QueryMap qm,
		...
		if (qm.getValueMap() != null) {
			query = createQuery(
					com.notebook.common.dao.support.Query.queryAccession(hql, qm),
					values);
			...
			query = createQuery(
					com.notebook.common.dao.support.Query.queryAccession(hql,
